...
- [ ] Improve GIS phone map from a sector list into a useful position-aware map presentation.
- [ ] Improve ambient city traffic/pedestrian simulation without pretending it is final VehicleAI.
- [ ] Add/extend automated tests for changes that can be validated without Unreal.
- [ ] Update PR body with exact verification state and remaining work.
...
| P0 | Campaign migration to real GIS | NOT STARTED | Move campaign interactables/interiors/checkpoints onto GIS coordinates with save migration |
...
| P0 | Vehicle AI | NOT STARTED | Dynamic route following, junction behavior, spacing, obstacle response, LOD |
| P0 | Vehicle pursuit AI | NOT STARTED | At least two pursuers, loss of sight, search, reacquisition, roadblocks |

...
class WROCLAWTHEGAME_API USliceMission : public UGameInstanceSubsystem
{
  ...
  public:
    ...
    Wroclaw::WorldState WorldState;
    UPROPERTY() TMap<FString, FWTGNPCSnapshot> NPCs;
    UPROPERTY() TMap<FString, FString> Settings;
    bool bDebugSession = false;
    virtual void Initialize(FSubsystemCollectionBase &Collection) override;
    void OnPhonePage(int32 Page);
    FString WorldMapText() const;
    bool CombineEvidence(int32 Index);
    bool CapturePhoto();
    ...
    FString PhoneText(int32 Page) const;
    FString QuestLogText() const;

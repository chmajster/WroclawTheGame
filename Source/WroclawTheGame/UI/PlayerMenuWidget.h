...
private:
    ...
    UPROPERTY() TObjectPtr<class UButton> MasterVolumeButton;
    UPROPERTY() TObjectPtr<class UButton> SFXVolumeButton;
    UPROPERTY() TObjectPtr<class UButton> MusicVolumeButton;
    UPROPERTY() TObjectPtr<class UButton> UIVolumeButton;
    UPROPERTY() TObjectPtr<class UProgressBar> MasterVolumeMeter;
    UPROPERTY() TObjectPtr<class UProgressBar> SFXVolumeMeter;
    UPROPERTY() TObjectPtr<class UProgressBar> MusicVolumeMeter;
    ...
    UPROPERTY() TObjectPtr<class USlider> MusicVolumeSlider;
    ...
    class UBorder* MakeCard(const FMargin& CardPadding = FMargin(18));
    ...
    UFUNCTION() void CycleMasterVolume();
    UFUNCTION() void CycleSFXVolume();
    UFUNCTION() void CycleMusicVolume();
    UFUNCTION() void CycleUIVolume();
    UFUNCTION() void SetMasterVolumeFromSlider(float Volume);
    UFUNCTION() void SetSFXVolumeFromSlider(float Volume);
    UFUNCTION() void SetMusicVolumeFromSlider(float Volume);
